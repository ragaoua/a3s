...
from src.observability.tracing import tracing_instrumentation
...
def main() -> None:
    ...
    with tracing_instrumentation(config):
        # NOTE: Lazily import build_a2a_server, inside the tracing context.
        # The StarletteInstrumentor set up by tracing_instrumentation()
